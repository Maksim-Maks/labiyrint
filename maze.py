...
text_lose = font.render("YOU LOST!", True, (255,0,0))
...
while not game_over:
    ...
    if not finish:
        ...
        walls_collision = any([pygame.sprite.collide_rect(player,w) for w in walls])


        if pygame.sprite.collide_rect(player, enemy) or walls_collision:
            finish = True
